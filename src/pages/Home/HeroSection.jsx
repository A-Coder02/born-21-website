                ...
                <div className="relative z-10">
                    ...
                    <div className=" hero-content-wrapper mb-8 md:mb-24 !mx-auto text-white rounded-b-[5rem] text-center relative flex- flex-col items-center">
                        ...
                        <Button
                            ...
                            endIcon={<img src={Svg} className=' md:w-6 md:h-6 w-3 h-3 filter invert relative bottom-0.5 left-1.5' />} variant='primary' size='lg' className='shadow-[0px_2px_1px_1px_#00000066] group mx-auto overflow-hidden relative hover:!bg-primary'>
