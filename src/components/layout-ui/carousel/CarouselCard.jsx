...
const CarouselCard = ({ theme = {}, card, className = '', style = null }) => {
    return <article style={style} className={`${theme?.cardClassName?.container} flex flex-col  py-5 px-8 rounded-4xl flex-[0_0_24rem] min-h-96 h-[26rem] md:h-[30rem] ${className} transition-all duration-[1000ms] ease-[cubic-bezier(0.25,1.25,0.5,1)]`}>
