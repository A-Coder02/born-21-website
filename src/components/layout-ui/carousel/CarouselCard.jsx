...
const CarouselCard = ({ theme = {}, card, className = '', style = null }) => {
    return <article style={style} className={`${theme?.cardClassName?.container}  py-5 px-8 rounded-4xl flex-[0_0_24rem] min-h-96 h-[24rem] md:h-[28rem] ${className} transition-all duration-[1000ms] ease-[cubic-bezier(0.25,1.25,0.5,1)]`}>
        ...
        <div className="flex gap-3 items-center">
            <div className="">
                <p className="text-sm text-warning font-medium">{card?.client?.name}</p>
